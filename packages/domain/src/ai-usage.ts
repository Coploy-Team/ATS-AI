export type AiUsageSource =
	...
	| 'core'
	| 'whatsapp_interview'
	/** Gateway de IA do plugin Motor  — inferência de instância licenciada. */
	| 'plugin_gateway'
...
export type AiUsageSurface =
	...
	| 'hunting_intent'
	| 'batch'
	/** Chamada de chat vinda do gateway do plugin sem surface declarada. */
	| 'gateway_chat'
	/** Transcrição de áudio vinda do gateway do plugin. */
	| 'gateway_whisper'
