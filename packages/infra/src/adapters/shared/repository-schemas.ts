...
export const AiUsageEventRepositorySchema = z.object({
	...
	source: z.enum(['ai_engine', 'orchestrator', 'core', 'whatsapp_interview']),
	surface: z.string(),
	provider: z.string(),
	model: z.string(),
...
export const AdminUserRepositorySchema = z.object({
	id: z.string(),
	email: z.string(),
	name: z.string(),
	role: z.enum(['admin_master', 'suporte', 'comercial']),
	mfaEnabled: optionalBoolean,
	createdAt: optionalDate,
	lastSeenAt: optionalDate,
}).passthrough()

export const AuditLogRepositorySchema = z.object({
	id: z.string(),
	at: z.preprocess((v) => {
...
export const EnterpriseContractRepositorySchema = z.object({
	id: z.string(),
	companyId: z.string(),
	companyName: optionalString,
	monthlyAmountMinor: z.number(),
	currency: z.string(),
	interviewsQuota: optionalNumber,
	overageRateMinor: optionalNumber,
	billingDayOfMonth: optionalNumber,
	startAt: optionalDate,
	endAt: optionalDate,
...
export const EnterprisePaymentRepositorySchema = z.object({
	id: z.string(),
	contractId: z.string(),
	companyId: z.string(),
	companyName: optionalString,
	...
	overageRateMinor: optionalNumber,
	overageAmountMinor: z.number(),
	totalAmountMinor: z.number(),
	currency: z.string(),
	status: z.enum(['pending', 'paid', 'cancelled']),
	paidAt: optionalDate,
	paidMethod: optionalString,
	notes: optionalString,
	createdAt: optionalDate,
	updatedAt: optionalDate,
	createdBy: z.string(),
