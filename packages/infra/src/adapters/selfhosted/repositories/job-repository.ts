...
function mapQuestionFromRow(row: PostJobQuestionRow | PostJobAdditionalQuestionRow) {
	return {
		// sem o id, a entrevista inteira quebra no selfhosted: o app manda
		// idQuestion=undefined e o orchestrator recusa a resposta ("Question
		// is not the current question") — achado do 1º teste real do plugin
		id: row.id,
