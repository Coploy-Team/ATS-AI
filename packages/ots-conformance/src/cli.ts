...
/**
 * Verificação INDEPENDENTE : assinatura Ed25519 contra a
...
/**
 * O binding REST é GERADO do artefato : o openapi.json
...
/**
 * Conformidade do binding REST  contra um provedor VIVO.
