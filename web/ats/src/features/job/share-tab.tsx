...
export function ShareTab() {
	...
	const job = data?.data as
		| { interviewUrl?: string; public?: boolean; stopped?: boolean; jobName?: string }
		| undefined
				...
				<div className='flex flex-col gap-4'>
					{portalJobUrl && (
						<Card title={t('share.careersTitle')} description={t('share.portalDescription')}>
							<div className='flex flex-col gap-4'>
								<CopyField label={t('share.careersLink')} value={portalCareersUrl} />
								{isPublic && <CopyField label={t('share.jobPageLink')} value={portalJobUrl} />}
							</div>
							{!isPublic && (
	...
	return (
		<Page title={t('share.title')} subtitle={t('share.subtitle')}>
			<div className='flex flex-col gap-4'>
				...
				>
					{interviewUrl ? (
						<CopyField label={t('share.interviewLink')} value={interviewUrl} />
					) : (
				...
				<Card title={t('share.careersTitle')} description={t('share.careersDescription')}>
					...
					{careersUrl && (
						<div className='flex flex-col gap-4'>
							<CopyField label={t('share.careersLink')} value={careersUrl} />
							{isPublic && <CopyField label={t('share.jobPageLink')} value={jobPageUrl} />}
							{isPublic && <CopyField label={t('share.applyLink')} value={applyUrl} />}
						</div>
					)}
