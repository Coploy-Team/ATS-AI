...
export const env = createEnv(
	z.object({
		...
		/**
		 * Servidor de licenças do plugin Motor (ADR-008) — a instalação da
		 ...
		 */
		CANDIDATE_APP_URL: z.string().url().default('https://candidato.coploy.io'),
		/**
		 ...
		 * o link.
		 */
		ATS_APP_URL: z.string().url().default('https://ats.coploy.io'),

		GUPY_CONNECTOR_BASE_URL: z.string().optional(),
		GUPY_CONNECTOR_API_KEY: z.string().optional(),

		BQ_BILLING_PROJECT_ID: z.string().default('coployf'),
		BQ_BILLING_TABLE: z
			.string()
			.default(
				'coployf.billing_export.gcp_billing_export_resource_v1_01725D_93EA64_9A918F',
			),
