...
export const DASHBOARD_URLS = {
	// Endereço desta instalação, não de um produto hospedado por terceiro.
	INTERVIEW_RESULTS: `${process.env.ATS_APP_URL ?? ''}/interview`,
	CANDIDATE_INFO: `${process.env.ATS_APP_URL ?? ''}/candidate-info`,
} as const
