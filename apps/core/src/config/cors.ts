...
const ALLOWED_ORIGINS: Record<string, string[]> = {
  production: [
    // Domínios principais da Coploy
    'https://coploy.io',
    'https://dashboard.coploy.io',
    'https://dashboard.ca.coploy.io',
    'https://recruiter.coploy.io',
    'https://interview.ca.coploy.io',
    // Firebase Hosting (produção)
    'https://prd-coploy-dashboard.web.app',
    'https://prd-coploy-interview.web.app',
    // Subdomínios dinâmicos (job portals)
    /^https:\/\/[a-z0-9-]+\.coploy\.io$/.source,
  ],
  homolog: [
    // Ambientes de staging/homologação
    'https://homolog.coploy.io',
    'https://staging.coploy.io',
    'https://app-homolog.coploy.io',
    // Firebase Hosting (homolog) — os apps servidos em *.web.app chamam a API
    // por origem diferente, então precisam constar aqui explicitamente
    'https://ats-hml.web.app',
    'https://ats-hml.firebaseapp.com',
    'https://dashboard-recruiter-hml.web.app',
    'https://interview-hml.web.app',
    'https://hml-coploy-platform.web.app',
    'https://dashboard-candidate-hml.web.app',
    // Subdomínios dinâmicos (job portals) em homolog
    /^https:\/\/[a-z0-9-]+\.coploy\.io$/.source,
    // Desenvolvimento local
    'http://localhost:3000',
    'http://localhost:3001',
    'http://localhost:5173',
    'http://localhost:5177', // web/ats (v2)
    'http://127.0.0.1:3000',
    'http://127.0.0.1:5173',
  ],
  testing: [
...
const DYNAMIC_ORIGIN_PATTERNS: RegExp[] = [
  // Subdomínios da Coploy (job portals customizados)
  /^https:\/\/[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?\.coploy\.io$/,
]
