...
export interface CandidateFilters {
	...
	/**
	 * Alcance da SESSÃO — vagas que a pessoa enxerga; `null`/ausente = todas.
	 *
	 * Não é filtro do cliente. A base de Candidatos é a lista de TODA a
	 * empresa: sem este recorte, o recrutador não via a vaga alheia mas via os
	 * candidatos dela, com nome, e-mail, telefone e nota. A parede só existe se
	 * valer em todas as portas.
	 */
